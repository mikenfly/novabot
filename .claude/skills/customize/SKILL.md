---
name: customize
description: Add new capabilities or modify NovaBot behavior. Use when user wants to add channels (Telegram, Slack, email input), change triggers, add integrations, modify the router, or make any other customizations. This is an interactive skill that asks questions to understand what the user wants.
---

# NovaBot Customization
...
1. Ask: "Should Telegram use the same @Nova trigger, or a different one?"
